...
adjectives = ["Karan", "Rohan", "Joy", "Icy", "Valiant", "Clever", "Devoted", "Frost", "Bold", "Merry", "Titan", "Rapid"]
nouns = ["Lane", "Summit", "Lion", "Serpent", "Griffin", "Jaguar", "Hawk", "Whale", "Fox", "Condor", "Bison", "Viper"]
